...
void *handle_client(void *arg)
{
    ...
    else
    {
        ...
        if (strcmp(command, "CREATE") == 0)
        {
            ...
            // str[0]='\0';
            // int server_index = search_path(path);
            // strcat(str, storage_servers[server_index].accessible_paths[0]);
            // int success2 = -1;
            // if (storage_servers[storage_servers[server_index].replica1].removed == 0)
            // {
            //     strcat(str, storage_servers[storage_servers[server_index].replica1].accessible_paths[0]);
            //     success2 = send_create_command(type, name, str);
            // }
            // else if (storage_servers[storage_servers[server_index].replica2].removed == 0)
            // {
            //     strcat(str, storage_servers[storage_servers[server_index].replica2].accessible_paths[0]);
            //     success2 = send_create_command(type, name, str);
            // }
        ...
        else if (strcmp(command, "DELETE") == 0)
        {
            ...
            int success1 = send_delete_command(type, name, path);
            char str[5000];
            str[0] = '\0';
            int server_index = search_path(path);
            strcat(str, storage_servers[server_index].accessible_paths[0]);
            ...
            {
                strcat(str, storage_servers[storage_servers[server_index].replica1].accessible_paths[0]);
                success2 = send_delete_command(type, name, str);
            }
            else if (storage_servers[storage_servers[server_index].replica2].removed == 0)
            {
                strcat(str, storage_servers[storage_servers[server_index].replica2].accessible_paths[0]);
        ...
        else if (strcmp(command, "COPY") == 0)
        {
            ...
            // {
            //     strcat(str, storage_servers[storage_servers[server_index].replica1].accessible_paths[0]);
            //     success2 = send_copy_command(typecopy, path, str);
            // }
            // else if (storage_servers[storage_servers[server_index].replica2].removed == 0)
            // {
            //     strcat(str, storage_servers[storage_servers[server_index].replica2].accessible_paths[0]);
